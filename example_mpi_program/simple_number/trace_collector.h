...
public:
    ...
    void CreateMetaFile(std::string folderPath){
        std::string file_name = folderPath + "/meta_file";
    ...
    void CreateTraceFile(std::string folderPath){
        std::string file_name = folderPath + "/trace_rank_" + std::to_string(_rank_process);
        std::ofstream file(file_name);
